...
namespace MinecraftClient.Protocol
{
    ...
    public class ReplayHandler
    {
        ...
        public string GetReplayDefaultName() {
            ...
            else return Replay.Init.v.replayName.Replace("{year}", now.Year.ToString()).Replace("{month}", now.Month.ToString()).Replace("{hour}", now.Hour.ToString()).Replace("{minute}", now.Minute.ToString()).Replace("{second}", now.Second.ToString()).Replace("{day}", now.Day.ToString()) + ".mcpr";
        }
